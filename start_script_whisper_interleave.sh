...
#SBATCH --job-name=int_s2_small_verbatim 
#SBATCH --nodes=1              #161
...
#SBATCH --output=/leonardo_work/EUHPC_A01_006/experiments_whisper/logs/preprocess_data_singlenode/sbatch_logs/sbatch-%J.log
#SBATCH --exclude=lrdn1765,lrdn3032,lrdn2751,lrdn0959,lrdn1072,lrdn2031,lrdn0970,lrdn1753,lrdn1636,lrdn3146,lrdn2631,lrdn0465,lrdn0923,lrdn1005,lrdn1457,lrdn1474,lrdn1509,lrdn1597,lrdn1668,lrdn2177,lrdn2371,lrdn2595,lrdn2668
#SBATCH --requeue
...
export CHECKPOINT_DIR="${PROJECT}/checkpoints/whisper-large"
export CONFIG_DIR="${PROJECT}/configs"
CONTAINER_PATH="/leonardo_work/EUHPC_A01_006/containers/whisper-flash-new"
LOGGING=$PROJECT/logs/preprocess_data_singlenode # Make sure to create logs/ before running this script
...
cmd="srun $SRUN_ARGS \
      singularity exec --nv -B /leonardo_work/EUHPC_A01_006,/leonardo_scratch/large/userexternal/lvesterb,/leonardo_scratch/large/userexternal/jsikora0   $CONTAINER_PATH bash $PROJECT/$TRAIN_SCRIPT"    
