...
#SBATCH --job-name=s-s2_verbatim # create a short name for your job
#SBATCH --nodes=4         #161
...
##SBATCH --exclude=lrdn1765,lrdn2040,lrdn1542,lrdn3032,lrdn2751,lrdn0959,lrdn1072,lrdn2031,lrdn0970,lrdn1753,lrdn1636,lrdn3146,lrdn2631
##SBATCH --requeue
...
export CHECKPOINT_DIR="/leonardo_work/EUHPC_A01_006/models/whisper-small"
export CONFIG_DIR="${PROJECT}/configs"
CONTAINER_PATH="/leonardo_work/EUHPC_A01_006/containers/whisper-flash-new"
LOGGING=$PROJECT/logs/whisper-small # Make sure to create logs/ before running this script
