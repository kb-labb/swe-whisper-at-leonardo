...
#SBATCH --job-name=l-s2_verbatim_lr1e-6 # create a short name for your job
#SBATCH --nodes=8         #161
...
#SBATCH --exclude=lrdn1765,lrdn3032,lrdn2751,lrdn0959,lrdn1072,lrdn2031,lrdn0970,lrdn1753,lrdn1636,lrdn3146,lrdn2631,lrdn0040,lrdn0084,lrdn0149,lrdn0189,lrdn0211,lrdn0233,lrdn0259,lrdn0278 
##SBATCH --requeue
...
export CHECKPOINT_DIR="/leonardo_work/EUHPC_A01_006/models/whisper-large"
export CONFIG_DIR="${PROJECT}/configs"
CONTAINER_PATH="/leonardo_work/EUHPC_A01_006/containers/whisper-flash-new"
LOGGING=$PROJECT/logs/whisper-large # Make sure to create logs/ before running this script
...
cmd="srun $SRUN_ARGS \
      singularity exec --nv -B /leonardo_work/EUHPC_A01_006,/leonardo_scratch/large/userexternal/jsikora0,/leonardo_scratch/large/userexternal/lvesterb $CONTAINER_PATH bash $PROJECT/$TRAIN_SCRIPT"
