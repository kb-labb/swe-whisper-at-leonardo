...
#SBATCH --job-name=med-s2_verb # create a short name for your job
#SBATCH --nodes=8         #161
...
#SBATCH --output=/leonardo_work/EUHPC_A01_006/experiments_whisper/logs/whisper-medium/sbatch_logs/sbatch-%J.log
...
export CHECKPOINT_DIR="/leonardo_work/EUHPC_A01_006/models/whisper-medium"
export CONFIG_DIR="${PROJECT}/configs"
CONTAINER_PATH="/leonardo_work/EUHPC_A01_006/containers/whisper-flash-new"
LOGGING=$PROJECT/logs/whisper-medium # Make sure to create logs/ before running this script
